...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-input-group', __webpack_require__(3));
    Vue.component('detail-input-group', __webpack_require__(6));
    Vue.component('form-input-group', __webpack_require__(9));
});
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          ...
          [
            _vm.position === "before"
              ? _c("div", { staticClass: "flex -mr-px w-2/5" }, [
                  _c(
                    "span",
                    {
                      staticClass:
                        "w-full flex px-3 bg-40 form-input-bordered rounded-r-none items-center border-r-0"
                    },
            ...
            _vm.position === "after"
              ? _c("div", { staticClass: "flex -mr-px w-2/5" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "w-full flex px-3 bg-40 form-input-bordered rounded-l-none items-center border-l-0"
                    },
                    [_vm._v(_vm._s(_vm.text))]
                  )
                ])
